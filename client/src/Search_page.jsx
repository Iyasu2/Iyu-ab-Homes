...
const Search_page = () => {
  ...
  const filteredItems = homes.filter(
    (home) =>
      ...
      home.Price.toLowerCase().includes(query.toLowerCase()) ||
      home.Floors.toLowerCase().includes(query.toLowerCase()) ||
      home.Total_Area.toLowerCase().includes(query.toLowerCase()) ||
      home.Built_in_Area.toLowerCase().includes(query.toLowerCase())
  );
