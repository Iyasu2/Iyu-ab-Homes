...
const PropertyDetails = ({ property }) => {
  ...
  return (
    <div className="property-details">
      ...
      <p><strong>Total Area: </strong>{property.totalArea}</p>
      <p><strong>Built-in Area: </strong>{property.builtInArea}</p>
      ...
      <p><strong>Accommodation: </strong>{property.accommodation}</p>
      <p><strong>Image: </strong>{property.image}</p>
