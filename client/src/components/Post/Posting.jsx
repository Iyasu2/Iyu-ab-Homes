...
function Post({ property }) {
  const [formData, setFormData] = useState({
    type: property.type || "",
    built_in_area: property.builtInArea || "",
    total_area: property.totalArea || "",
    state: property.state || "",
    city: property.city || "",
    town: property.town || "",
    floors: property.floors || "",
    bedrooms: property.bedrooms || "", // New field
    bathrooms: property.bathrooms || "", // New field
    accommodation: property.accommodation || "",
    user_id: property.userId || "",
    image: null,
  });

  console.log(property.builtInArea);
  console.log(property.accommodation);
  ...
  const privateResidentFloorOptions = Array.from(
    { length: 30 },
    (_, i) => i
  ).map((value) => (
  ...
  const otherFloorOptions = Array.from({ length: 30 }, (_, i) => i + 1).map(
    (value) => (
      <option key={value} value={value}>
        {value === 1
          ? `${value}st`
        ...
        <div className="col-md-8">
          <div className="post-form-box">
            ...
            <form onSubmit={handleSubmit}>
              ...
              {formData.type !== "apartment" &&
                formData.type !== "condominium" && (
                  <div className="form-group">
                    <label htmlFor="built_in_area" className="form-label">
                      Built-in Area
                    </label>
              ...
              <div className="mb-3">
                {formData.type === "private_resident" ||
