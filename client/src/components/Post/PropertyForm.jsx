...
const PropertyForm = ({ property }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    totalArea: property
      ? property.totalArea
        ? property.totalArea.split(" ")[0]
        : ""
      : "",
    builtInArea: property
      ? property.builtInArea
        ? property.builtInArea.split(" ")[0]
        : ""
      : "",
    ...
    accommodation: property ? property.accommodation || "" : "",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const url = property
        ...
        : "https://iyu-ab-homes.vercel.app/api/properties";
